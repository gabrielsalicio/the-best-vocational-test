...
educacion_fisica = Career.create(name: 'Educación física', description:'', duration: '')
...
matematica      = Career.create(name: 'Matemáticas', description:'', duration: '')
...
ques13 = Question.create(name: 'Pregunta°13',
    ...
    number: 13,
    type: 'Multiple-Choice')
    choice1_q13 = Choice.create(text: '1- La importancia de la expresión artística en el desarollo de la identidad de los pueblos.', question:ques13)
        Outcome.create(choice: choice1_q13, career: sociologia)
    choice2_q13 = Choice.create(text: '2- La arqueología urbana como forma de aprender acerca de la historia cultural de una ciudad.', question:ques13)
        Outcome.create(choice: choice2_q13, career: historia)
    choice3_q13 = Choice.create(text: '3- La tecnología satelital en un proyecto para descubrir actividad volcánica para prevenir catástrofes climaticas.', question:ques13)
...
ques14 = Question.create(name: 'Pregunta°14',
    ...
    number: 14,
    type: 'Multiple-Choice')
    choice1_q14 = Choice.create(text: '1- La práctica de deportes y su influencia positiva en el estado de ánimo de las personas.', question:ques14)
        Outcome.create(choice: choice1_q14, career: educacion_fisica)
    choice2_q14 = Choice.create(text: '2- Los pensadores del siglo XX y su aporte a la gestión de las organizaciones.', question:ques14)
        Outcome.create(choice: choice2_q14, career: filosofia)
        Outcome.create(choice: choice2_q14, career: historia)
    choice3_q14 = Choice.create(text: '3- Las mascotas y su incidencia en la calidad de vida de las personas no videntes.', question:ques14)
        Outcome.create(choice: choice3_q14, career: veterinaria)
    choice4_q14 = Choice.create(text: '4- El uso de la PC como herramienta para el control de los procesos industriales.', question:ques14)
...
ques15 = Question.create(name: 'Pregunta°15',
    ...
    number: 15,
    type: 'Multiple-Choice')
    choice1_q15 = Choice.create(text: '1- Director de una investigación técnico científica.', question:ques15)
    ...
    choice2_q15 = Choice.create(text: '2- Gerente general de una empresa reconocida por su responsabilidad social.', question:ques15)
        Outcome.create(choice: choice2_q15, career: economia)
    choice3_q15 = Choice.create(text: '3- Un deportista famoso por su destreza física y su ética profesional.', question:ques15)
        Outcome.create(choice: choice3_q15, career: educacion_fisica)
    choice4_q15 = Choice.create(text: '4- Experto en la detección precoz de enfermedades neurológicas en niños.', question:ques15)
        Outcome.create(choice: choice4_q15, career: medicina)
    choice5_q15 = Choice.create(text: '5- Un agente de prensa audaz, número uno en el ranking de notas a celebridades.', question:ques15)
